 ...
 *
 * ```tsx
 * import { CopilotRuntime } from "@noahlocal/copilotkit-runtime";
 *
...
export interface CopilotRuntimeConstructorParams<T extends Parameter[] | [] = []> {
   ...
   * (e.g., `@noahlocal/copilotkit-runtime`, `ai`) to establish a connection.
...
export class CopilotRuntime<const T extends Parameter[] | [] = []> {
  ...
  constructor(params?: CopilotRuntimeConstructorParams<T>) {
    ...
    //   })
    // ) {
    //   console.warn('LangGraph Agent class should be imported from @noahlocal/copilotkit-runtime. ')
    // }
